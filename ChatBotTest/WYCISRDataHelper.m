...
@implementation WYCISRDataHelper
...
/*
 解析听写json格式的数据
 params例如：
{"sn":1,"ls":true,"bg":0,"ed":0,"ws":[{"bg":1,"cw":[{"sc":0.0,"w":"语音"}]},{"bg":1,"cw":[{"sc":0.0,"w":"视频"}]},{"bg":1,"cw":[{"sc":0.0,"w":"有"}]},{"bg":1,"cw":[{"sc":0.0,"w":"声音"}]},{"bg":1,"cw":[{"sc":0.0,"w":"吗"}]},{"bg":0,"cw":[{"sc":0.0,"w":""}]}]}
 */
